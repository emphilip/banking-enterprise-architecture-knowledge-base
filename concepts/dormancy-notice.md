...
**Definition.** Dormancy Notice is the abandoned-property letter sent to a dormant deposit account holder before unclaimed funds are escheated to the state. Dormancy Notice is the due-diligence artifact in the dormancy and escheatment branch of account servicing.

**Also known as:** Abandoned Property Letter, Pre-Escheatment Notice.

## Relationships
- Dormancy Notice is related to the Deposits & Accounts domain.
- Dormancy Notice mentions Issue Dormancy Notice.
- Dormancy Notice mentions Dormancy & Escheatment.
